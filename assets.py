...
class AssetManager:
    def __init__(self):
        ...
        self.player_img.set_colorkey(Colours.BLACK)  # Цвет прозрачности для игрока
        self.mobs_img = pygame.image.load(os.path.join(img_folder, 'bomb.png')).convert()
        self.mobs_img.set_colorkey(Colours.BLACK)  # Цвет прозрачности для врагов
        self.bullet_img = pygame.Surface((10, 20))
        self.bullet_img.fill(Colours.YELLOW)
        self.bullet_img.set_colorkey(Colours.BLACK)  # Цвет прозрачности для пуль
